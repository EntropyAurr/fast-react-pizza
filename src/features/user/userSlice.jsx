...
function getPosition() {
  return new Promise(function (resolve, reject) {
    ...
    // navigator.geolocation is a built-in web API in modern web browsers that allows to access the user's geographic location (with their permission): latitude, longitude, altitude, speed, accuracy
  });
}
