    ...
    <div className="px-4 py-6">
      ...
      <Form method="POST" action="">
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <input className="input flex-grow" type="text" name="customer" required placeholder="Enter your name..." defaultValue={username} />
        </div>
        ...
        <div className="mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="flex-grow">
            <input className="input w-full" type="text" name="address" required placeholder="Enter your address" />
          </div>
        </div>
